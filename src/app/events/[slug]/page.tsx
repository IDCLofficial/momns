    ...
    <>
      ...
      <div className="bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 pt-6">
          <button 
            onClick={() => router.back()}
            className="flex cursor-pointer items-center text-green-700 hover:text-green-800 transition-colors mb-4"
          >
        ...
        <section className="w-full max-w-6xl mx-auto px-4 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
            ...
            <div><span className="font-semibold">ORGANIZER:</span> <span className="ml-2">Ministry of Industry, Mines & Solid Minerals, Imo State</span></div>
