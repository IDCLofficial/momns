  ...
  return (
    <section className="w-full py-16 bg-white flex flex-col lg:flex-row items-center gap-10 px-6 lg:px-20">
      <div className="flex-1 flex flex-col gap-6">
        <h2 className="text-3xl lg:text-4xl font-bold">Ongoing Projects: Ministry of Industry and Solid Minerals</h2>
        ...
        <div className="flex gap-6 mt-6">
          <Image src="/images/iirs.jpeg" alt="Project Field" width={120} height={80} className="rounded" />
          <Image src="/images/ocda.jpeg" alt="Initiative" width={120} height={80} className="rounded" />
        </div>
      </div>
      <div className="flex-1 flex justify-center">
        <div className="w-full max-w-md h-72 relative rounded-lg overflow-hidden">
          <Image src="/images/stock6.jpg" alt="Ongoing Projects" fill className="object-cover" />
        </div>
      </div>
    </section>
  );
