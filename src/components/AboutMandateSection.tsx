  ...
  return (
    <section className={`relative w-full p-8 py-20 bg-[url('/images/gradient.png')] bg-no-repeat bg-cover shadow-lg overflow-hidden`}>
      ...
      <div className="w-[94%] mx-auto">
        ...
        {/* top section */}
        <div className="px-3 py-2 mb-3 bg-white text-gray-900 rounded-full font-semibold text-sm shadow-lg w-fit">
          {label}
        </div>
        <div className="mb-16  mx-auto flex flex-col lg:flex-row justify-between gap-10 items-start">
          ...
          <div className="flex-1 flex flex-col justify-between h-full gap-12 items-start mt-2 sm:mt-4 lg:mt-8">
            ...
            <Link href="/about" passHref legacyBehavior>
              <button className="px-4 sm:px-6 py-2 bg-white text-gray-900 rounded font-semibold shadow hover:bg-gray-200 transition w-32 sm:w-36 min-w-[120px] h-10 text-sm sm:text-base text-center flex items-center justify-center whitespace-nowrap">
                {buttonText}
              </button>
            </Link>
          </div>
